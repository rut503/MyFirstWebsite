...
function changeThemeColors1() {
    ...
    document.documentElement.style.setProperty('--menu-button', 'url("Resources/icon_menu_1.png")');
    document.getElementById('pac-moji').src= "Resources/Pac_Moji_1.png";
}
...
function changeThemeColors2() {
    ...
    document.documentElement.style.setProperty('--background-color', '#000');
    document.documentElement.style.setProperty('--menu-button', 'url("Resources/icon_menu_2.png")');
    document.getElementById('pac-moji').src= "Resources/Pac_Moji_2.png";
}
...
function changeThemeColors3(){
    ...
    document.documentElement.style.setProperty('--background-color', '#000');
    document.documentElement.style.setProperty('--menu-button', 'url("Resources/icon_menu_3.png")');
    document.getElementById('pac-moji').src= "Resources/Pac_Moji_3.png";
}

function changeThemeColors4(){
    document.documentElement.style.setProperty('--first-color', '#FFCD38');
    document.documentElement.style.setProperty('--second-color', '#4A4A4A');
    document.documentElement.style.setProperty('--third-color', '#b31d1d');
    document.documentElement.style.setProperty('--forth-color', '#ffffff');
    document.documentElement.style.setProperty('--background-color', '#000');
    document.documentElement.style.setProperty('--menu-button', 'url("Resources/icon_menu_4.png")');
    document.getElementById('pac-moji').src= "Resources/Pac_Moji_4.png";
}
...
function changeThemeColors5(){
    ...
    document.documentElement.style.setProperty('--forth-color', '#eeeeee');
    document.documentElement.style.setProperty('--background-color', '#000');
    document.documentElement.style.setProperty('--menu-button', 'url("Resources/icon_menu_5.png")');
    document.getElementById('pac-moji').src= "Resources/Pac_Moji_5.png";
}

function changeThemeColors6(){
    document.documentElement.style.setProperty('--first-color', '#aaa');
    document.documentElement.style.setProperty('--second-color', '#555');
    document.documentElement.style.setProperty('--third-color', '#000');
    document.documentElement.style.setProperty('--forth-color', '#fff');
    document.documentElement.style.setProperty('--background-color', '#000');
    document.documentElement.style.setProperty('--menu-button', 'url("Resources/icon_menu_6.png")');
    document.getElementById('pac-moji').src= "Resources/Pac_Moji_6.png";
}
...
window.addEventListener("scroll", function() {
    ...
    if (scrolledHeight > 1 && scrolledHeight < 800) {
        welcomeText.style.transform = "translate(0px, " + scrolledHeight / 25 + "vw)";
    } else {
        welcomeText.style.transform = "translate(0,0)";
    }

    var gameTitle = document.querySelector(".games");
    if (scrolledHeight > 1500 && scrolledHeight < 2200) {
    ...
    var testShape = document.querySelectorAll(".test");
    if (scrolledHeight > 1) {
        for (var i = 0; i < testShape.length; i++) {
            var allTestShapes = testShape[i];
            allTestShapes.style.transform = "rotate(" + scrolledHeight + "deg)";
        }
    }

    var allRockets1 = document.querySelectorAll(".rockets1");
    if (scrolledHeight > 200 && scrolledHeight < 1900) {
        for (var w = 0; w < 25; w++) {
            allRockets1[w].style.transform = "translate(0, -" + scrolledHeight / 15 + "vw) rotate(-45deg)";
        }
        for (w = 25; w < 50; w++) {
            allRockets1[w].style.transform = "translate(0, -" + scrolledHeight / 25 + "vw) rotate(-45deg)";
        }
        for (w = 50; w < 75; w++) {
            allRockets1[w].style.transform = "translate(0, -" + scrolledHeight / 35 + "vw) rotate(-45deg)";
        }
        for (w = 75; w < 100; w++) {
            allRockets1[w].style.transform = "translate(0, -" + scrolledHeight / 45 + "vw) rotate(-45deg)";
        }
    }

});

////////////////////////////// Placing all the Rockets in a place to begin with /////////////////////////

function putRocketsInDivContainer() {
    var placedRockets = 0;
    var parent = document.getElementById('my_name_is_rut');

    while(placedRockets < 100){
        var newGroup = document.createElement("div");
        newGroup.setAttribute("class", "rockets1");
        parent.appendChild(newGroup);
        newGroup.innerHTML = '<i class="fa fa-rocket"></i>';
        placedRockets++;
    }
}

//////////////////////////////// Generating Random positions for rockets ////////////////////////////////
...
var firstTopArray = [];
var secondTopArray = [];
var randomTopValueArray = [];

var firstLeftArray = [];
var secondLeftArray = [];
var randomLeftValueArray = [];

var finalTopLeftArray = [];

while(r < 101){
    firstTopArray.push(r);
    r++;
}

while(p < 87){
    firstLeftArray.push(p);
    p++;
}while(s < 15){
    firstLeftArray.push(Math.floor(Math.random() * 86));
    s++;
}

while(k <= 99){
    var randomTopValue = Math.floor(Math.random() * firstTopArray.length);
    randomTopValueArray.push(randomTopValue);
    secondTopArray.push(firstTopArray[randomTopValue]);
    firstTopArray.splice(randomTopValue, 1);

    var randomLeftValue = Math.floor(Math.random() * firstLeftArray.length);
    randomLeftValueArray.push(randomLeftValue);
    secondLeftArray.push(firstLeftArray[randomLeftValue]);
    firstLeftArray.splice(randomLeftValue, 1);

    k++;
}

finalTopLeftArray = secondTopArray.concat(secondLeftArray);


function showRandomPositions() {
    document.getElementById("display").innerHTML =
        "First X Array : " + firstTopArray + "<br>" +
        "Random X Value Array: " + randomTopValueArray + "<br>" +
        "Second X Array : " + secondTopArray + "<br><br>" +

        "First Y Array : " + firstLeftArray + "<br>" +
        "Random Y Value Array : " + randomLeftValueArray + "<br>" +
        "Second Y Array : " + secondLeftArray + "<br><br>" +

        "Final Top - Left Array : " + finalTopLeftArray + "<br>" ;
}

////////////////////////////////////////////////////////////////////////////////////////////////

function assignRocketPositions() {
    var allRockets1 = document.querySelectorAll(".rockets1");
    for(var i = 0; i < 100; i++){
        allRockets1[i].style.top = (20 + (finalTopLeftArray[i])) + "vw";
        allRockets1[i].style.left =  finalTopLeftArray[i+100]+ "vw";
    }
}

////////////////////////////////////////////////////////////////////////////////////////////////

function differentSizedRockets() {
    var allRockets1 = document.querySelectorAll(".rockets1");
    for(var i = 0; i < 25; i++){
        allRockets1[i].style.fontSize = "4vw";
    }
    for(i = 25; i < 50; i++){
        allRockets1[i].style.fontSize = "3vw";
    }
    for( i = 50; i < 75; i++){
        allRockets1[i].style.fontSize = "2vw";
    }
    for( i = 75; i < 100; i++){
        allRockets1[i].style.fontSize = "1vw";
    }
}
